...
exports.DEFAULT_FLOW_TIMEOUT = undefined;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 20:
            _context.next = 22;
            return (0, _flow.collectFlowCoverage)(opts.flowCommandPath, opts.flowCommandTimeout, opts.projectDir, opts.globIncludePatterns, opts.globExcludePatterns, opts.threshold, opts.concurrentFiles || 1, tmpDirPath, opts.strictCoverage, opts.excludeNonFlow);

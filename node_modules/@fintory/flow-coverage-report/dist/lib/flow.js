...
var collectFlowCoverageForFile = exports.collectFlowCoverageForFile = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(flowCommandPath, flowCommandTimeout, projectDir, filename, tmpDirPath, strictCoverage) {
  ...
  return function collectFlowCoverageForFile(_x4, _x5, _x6, _x7, _x8, _x9) {
...
function collectFlowCoverage(flowCommandPath, flowCommandTimeout, projectDir, globIncludePatterns, globExcludePatterns, threshold, concurrentFiles, tmpDirPath, strictCoverage, excludeNonFlow) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 11:
                            ...
                            waitForCollectedDataFromFiles.push(collectFlowCoverageForFile(flowCommandPath, flowCommandTimeout, projectDir, filename, tmpDirPath, strictCoverage).then(function (data) {
                              /* eslint-disable camelcase */
